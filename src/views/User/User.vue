<template>
    <div class="manage">
        <div class="manage-header">
            ...
            <CommonForm :inline="inline" :formLabel="searchFormLabel" :form="searchFrom">
    ...
    <el-dialog :title="operateType === 'add' ? '新增用户' : '更新用户'" v-model="isShow">
        <common-form :inline="inline" :formLabel="operateFormLabel" :form="operateForm" ref="form"></common-form>
        <template #footer>
